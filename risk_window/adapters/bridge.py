"""Bridge runtime adapter for risk_window."""
...
class BridgeRiskWindowAdapter:
    """Thin adapter between the detector and the real-robot Bridge loop."""
    ...
    def from_runtime_args(cls, config_path: str, asset_root: str, log_dir: str = "", action_policy: str = "log_only", overlay: bool = False):
        default_log_dir = log_dir if str(log_dir).strip() else os.path.join(".", "rollouts", "risk_window", "bridge")
    ...
    def apply_action_policy(self, proposed_action) -> Dict[str, Any]:
        ...
        elif self.action_policy == "dummy_wait":
