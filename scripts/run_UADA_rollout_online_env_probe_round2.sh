...
cat > "${SUMMARY_CSV}" <<'EOF'
variant,attack_mode,lr,exp_id,run_dir,iter,lambda_action_gap,lambda_history,lambda_history_legacy,lambda_ce,online_ce_mode,final_val_done_rate,final_val_episode_len,final_val_action_gap,final_val_history1,final_val_history2,final_val_ce,final_val_ce_objective,final_val_rollout_score,final_val_objective_score
EOF
